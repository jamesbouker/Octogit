...
class RefreshComponent: UIView {
    ...
    func addObservers() {
        scrollView.addObserver(self, forKeyPath: RefreshContentOffsetKey, options: .new, context: &kvoContext)
        scrollView.addObserver(self, forKeyPath: RefreshContentSizeKey, options: .new, context: &kvoContext)
    }
