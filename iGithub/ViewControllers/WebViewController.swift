...
class WebViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if toolbarWasHidden == nil {
            toolbarWasHidden = navigationController?.isToolbarHidden
        }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        navigationController?.isToolbarHidden = toolbarWasHidden!
    ...
    func updateToolbar() {
        ...
        setToolbarItems([flexibleSpace, backItem, flexibleSpace, forwardItem, flexibleSpace, loadItem, flexibleSpace, shareItem, flexibleSpace],
                        animated: false)
    }
